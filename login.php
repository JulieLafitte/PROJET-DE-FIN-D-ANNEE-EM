...
<head>
    ...
    <title>THE WEEKND - Connexion</title>
...
<body>
    <div class="row login-wrapp">
        <div class="col-12 login-logo">
            <img src="assets/icones/logo-blanc.svg" alt="">
        </div>
        ...
        <div class="col-12  loginform">
            <form action="verif.php" method="POST">
                ...
                <br>
                <input type="text" placeholder="Entrez votre identifiant" name="id" id="Id">
                <br>
